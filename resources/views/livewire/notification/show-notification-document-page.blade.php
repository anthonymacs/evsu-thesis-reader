{{-- resources/views/livewire/notification/show-notification-document-page.blade.php --}}
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Back to Notifications instead of Documents --}}
            <x-ui.button variant="secondary" size="sm" href="{{ route('notifications.index') }}">
                <x-slot:icon>
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @if ($showViewsModal)
        <div
            ...
            <div class="absolute inset-0 bg-black/50 backdrop-blur-sm"
                wire:click="$set('showViewsModal', false)"></div>
            ...
            <div class="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    ...
                    <button wire:click="$set('showViewsModal', false)"
                    ...
                    @forelse ($viewsByCourse as $course => $count)
                        ...
                        <div class="p-4 {{ $mc['bg'] }} rounded-xl border {{ $mc['border'] }}">
                            ...
                            <div class="w-full {{ $mc['bar_bg'] }} rounded-full h-2">
                                <div class="{{ $mc['bar_fill'] }} h-2 rounded-full transition-all duration-500"
